...
deriv <- frame$raw_data$derivatives
df3 <- filter_by_date(deriv$data, "date", "2025-01-01", Sys.Date())
...
macro <- frame$raw_data$macro
m2_data <- data.frame(
  date = macro$liquidity$m2_us$date,
  m2_yoy = macro$liquidity$m2_yoy * 100)
m2_data <- filter_by_date(m2_data, "date", "2025-01-01", Sys.Date())
...
dxy_df <- filter_by_date(dxy_df, "date", "2025-01-01", Sys.Date())
```
